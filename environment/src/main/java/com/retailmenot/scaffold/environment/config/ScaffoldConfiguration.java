...
/**
 * A simple configuration file that scans for components under the com.retailmenot.scaffold package structure and enables
 * the usage of DesiredCapabilitiesConfigurationProperties as an auto configuration for implementing projects.
 */
@Configuration
@SpringBootApplication
@ComponentScan(value = "com.retailmenot.scaffold")
