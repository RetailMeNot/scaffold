...
/**
 * A simple configuration file that scans for components under the io.github.kgress.scaffold package structure and enables
 * the usage of DesiredCapabilitiesConfigurationProperties as an auto configuration for implementing projects.
 */
@Configuration
@SpringBootApplication
@ComponentScan(value = "io.github.kgress.scaffold")
