...
public class InputWebElement extends BaseClickableAndTypableWebElement {
    ...
    /**
     * Creates a new {@link InputWebElement} and mark whether the element is hidden. It is highly recommended using
     ...
     */
    public InputWebElement(String cssSelector, boolean isHidden) {
     ...
     * {@link #InputWebElement(String cssSelector)} in almost all cases.
     *
     * @see BaseWebElement#BaseWebElement(By)
     * @param by        the {@link By} locator
     * @param isHidden  a {@link boolean} to specify if this element could be hidden
     */
    public InputWebElement(By by, boolean isHidden) {
        super(by, isHidden);
    }
     ...
     * @param isHidden a {@link boolean} to specify if this element could be hidden
     */
    public InputWebElement(By by, By parentBy, boolean isHidden) {
