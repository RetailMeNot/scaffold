...
public class BaseClickableWebElement extends BaseWebElement {
     ...
     */
    public BaseClickableWebElement(String cssSelector, boolean isHidden) {
    ...
    /**
     * Use this constructor when you'd like to locate an element with a {@link By} method different from
     * {@link By#cssSelector(String)} and set whether the element is hidden. We strongly recommend using
     * {@link #BaseClickableWebElement(String)} in almost all cases.
     *
     * @param by       the {@link By} locator
     * @param isHidden a {@link boolean} to specify if this element could be hidden
     */
    public BaseClickableWebElement(By by, boolean isHidden) {
        super(by, isHidden);
    }
     ...
     * @param isHidden a {@link boolean} to specify if this element could be hidden
     */
    public BaseClickableWebElement(By by, By parentBy, boolean isHidden) {
