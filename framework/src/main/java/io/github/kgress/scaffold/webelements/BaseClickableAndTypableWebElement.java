...
public class BaseClickableAndTypableWebElement extends BaseClickableWebElement {
    ...
    /**
     * Creates a new {@link BaseClickableAndTypableWebElement} and mark whether the element is hidden. It is highly
     * recommended using {@link By#cssSelector(String)} over another method, such as {@link By#xpath(String)},
     * in almost all cases as it can be less flaky and less reliant on DOM hierarchy.
     *
     * @see BaseWebElement#BaseWebElement(String)
     * @param cssSelector   the value of the {@link By#cssSelector(String)}
     * @param isHidden      a {@link boolean} to specify if this element could be hidden
     */
    public BaseClickableAndTypableWebElement(String cssSelector, boolean isHidden) {
    ...
    /**
     * Use this constructor when you'd like to locate an element with a {@link By} method different from
     * {@link By#cssSelector(String)} and markwhether the element is hidden. We strongly recommend using
     * {@link #BaseClickableAndTypableWebElement(String)} in almost all cases.
     *
     * @see BaseWebElement#BaseWebElement(By)
     * @param by        the {@link By} locator
     * @param isHidden  a {@link boolean} to specify if this element could be hidden
     */
    public BaseClickableAndTypableWebElement(By by, boolean isHidden) {
        super(by, isHidden);
    }
     ...
     * @param isHidden a {@link boolean} to specify if this element could be hidden
     */
    public BaseClickableAndTypableWebElement(By by, By parentBy, boolean isHidden) {
