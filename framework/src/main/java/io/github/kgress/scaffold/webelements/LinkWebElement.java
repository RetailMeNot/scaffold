...
public class LinkWebElement extends BaseClickableWebElement {
    ...
    /**
     * Creates a new {@link LinkWebElement} and mark whether the element is hidden. It is highly recommended using
     ...
     */
    public LinkWebElement(String cssSelector, boolean isHidden) {
     ...
     * {@link #LinkWebElement(String cssSelector)} in almost all cases.
     *
     * @see BaseWebElement#BaseWebElement(By)
     * @param by        the {@link By} locator
     * @param isHidden  a {@link boolean} to specify if this element could be hidden
     */
    public LinkWebElement(By by, boolean isHidden) {
        super(by, isHidden);
    }
     ...
     * @param isHidden a {@link boolean} to specify if this element could be hidden
     */
    public LinkWebElement(By by, By parentBy, boolean isHidden) {
     ...
     */
    @Deprecated
    public LinkWebElement(By by, By parentBy, WebElement webElement) {
     ...
     */
    @Deprecated
    public LinkWebElement(By by, WebElement webElement) {
        super(by, webElement);
    }
     ...
     */
    @Deprecated
    public LinkWebElement(WebElement webElement) {
        super(webElement);
    }
