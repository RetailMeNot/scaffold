...
public class InputWebElementTests extends BaseUnitTest {
    ...
    private final TestInputWebElement elementByCssSelector =
            new TestInputWebElement(SharedTestVariables.CSS_SELECTOR1);
    private final TestInputWebElement elementByClass =
            new TestInputWebElement(By.className(SharedTestVariables.CLASS_NAME));

    @Test
    public void testInputWebElement_byCss_sendKeys() {
    ...
    @Test
    public void testInputWebElement_byCss_getValue() {
        setBaseWhen(elementByCssSelector);
    ...
    @Test
    public void testInputWebElement_byCss_click() {
        setBaseWhen(elementByCssSelector);
    ...
    @Test
    public void testInputWebElement_byCss_isEnabled() {
        setBaseWhen(elementByCssSelector);
    ...
    @Test
    public void testInputWebElement_byCss_isDisabled() {
        setBaseWhen(elementByCssSelector);
    ...
    @Test
    public void testInputWebElement_byCss_isDisplayed() {
        setBaseWhen(elementByCssSelector);
    ...
    @Test
    public void testInputWebElement_byCss_isNotDisplayed() {
        setBaseWhen(elementByCssSelector);
    ...
    @Test
    public void testInputWebElement_byCss_isActive() {
        setBaseWhen(elementByCssSelector);
    ...
    @Test
    public void testInputWebElement_byCss_isNotActive() {
        setBaseWhen(elementByCssSelector);
        when(mockRawWebElement.getAttribute(SharedTestVariables.CLASS_ATTRIBUTE))
    ...
    @Test
    public void testInputWebElement_byCss_hasClass() {
        setBaseWhen(elementByCssSelector);
        when(mockRawWebElement.getAttribute(SharedTestVariables.CLASS_ATTRIBUTE))
                .thenReturn(SharedTestVariables.CLASS_NAME);
    ...
    @Test
    public void testInputWebElement_byCss_doesNotHaveClass() {
        setBaseWhen(elementByCssSelector);
    ...
    @Test
    public void testInputWebElement_byCss_getAttribute() {
        setBaseWhen(elementByCssSelector);
        when(mockRawWebElement.getAttribute(SharedTestVariables.CLASS_ATTRIBUTE))
                .thenReturn(SharedTestVariables.CLASS_NAME);
    ...
    @Test
    public void testInputWebElement_byCss_getText() {
        setBaseWhen(elementByCssSelector);
    ...
    @Test
    public void testInputWebElement_byCss_getTagName() {
        setBaseWhen(elementByCssSelector);
    ...
    @Test
    public void testInputWebElement_byCss_getLocation() {
        setBaseWhen(elementByCssSelector);
    ...
    @Test
    public void testInputWebElement_byCss_getSize() {
        setBaseWhen(elementByCssSelector);
    ...
    @Test
    public void testInputWebElement_byCss_getRect() {
        setBaseWhen(elementByCssSelector);
    ...
    @Test
    public void testInputWebElement_byCss_getCssValue() {
        setBaseWhen(elementByCssSelector);
    ...
    @Test
    public void testInputWebElement_byCss_getRawWebElement_success() {
        setBaseWhen(elementByCssSelector);
        assertEquals(mockRawWebElement, elementByCssSelector.getRawWebElement());
    }

    @Test
    public void testInputWebElement_byCss_getRawWebElement_fail() {
        setBaseWhen(elementByCssSelector);
    ...
    @Test
    public void testInputWebElement_byCss_getRawParentWebElement_success() {
        setBaseWhen(elementByCssSelector);
    ...
    @Test
    public void testInputWebElement_byCss_getRawParentWebElement_fail() {
        setBaseWhen(elementByCssSelector);
    ...
    @Test
    public void testInputWebElement_byCss_scrollIntoView_success() {
        setBaseWhen(elementByCssSelector);
        setWhenScrollIntoViewSucceed();
    ...
    @Test
    public void testInputWebElement_byCss_scrollIntoView_fail() {
        setBaseWhen(elementByCssSelector);
    ...
    @Test
    public void testInputWebElement_byClass_sendKeys() {
        setBaseWhen(elementByClass);
        elementByClass.sendKeys(SharedTestVariables.SEND_KEYS_TEXT);
        verify(mockRawWebElement, times(1)).sendKeys(SharedTestVariables.SEND_KEYS_TEXT);
    }

    @Test
    public void testInputWebElement_byClass_getValue() {
        setBaseWhen(elementByClass);
        when(mockRawWebElement.getAttribute(SharedTestVariables.VALUE_ATTRIBUTE))
                .thenReturn(SharedTestVariables.ELEMENT_VALUE);

        var elementValue = elementByClass.getValue();
        assertEquals(SharedTestVariables.ELEMENT_VALUE, elementValue);
    }

    @Test
    public void testInputWebElement_byClass_click() {
        setBaseWhen(elementByClass);
        setWhenScrollIntoViewSucceed();
    ...
    @Test
    public void testInputWebElement_byClass_isEnabled() {
        setBaseWhen(elementByClass);
        when(mockRawWebElement.isEnabled()).thenReturn(true);
    ...
    @Test
    public void testInputWebElement_byClass_isDisabled() {
        setBaseWhen(elementByClass);
        when(mockRawWebElement.isEnabled()).thenReturn(false);
    ...
    @Test
    public void testInputWebElement_byClass_isDisplayed() {
        setBaseWhen(elementByClass);
        when(mockRawWebElement.isDisplayed()).thenReturn(true);
    ...
    @Test
    public void testInputWebElement_byClass_isNotDisplayed() {
        setBaseWhen(elementByClass);
        when(mockRawWebElement.isDisplayed()).thenReturn(false);
    ...
    @Test
    public void testInputWebElement_byClass_isActive() {
        setBaseWhen(elementByClass);
        when(mockRawWebElement.getAttribute(SharedTestVariables.CLASS_ATTRIBUTE))
                .thenReturn(SharedTestVariables.ACTIVE_CLASS_NAME);
    ...
    @Test
    public void testInputWebElement_byClass_isNotActive() {
        setBaseWhen(elementByClass);
        when(mockRawWebElement.getAttribute(SharedTestVariables.CLASS_ATTRIBUTE))
                .thenReturn(SharedTestVariables.CLASS_NAME);
    ...
    @Test
    public void testInputWebElement_byClass_hasClass() {
        setBaseWhen(elementByClass);
        when(mockRawWebElement.getAttribute(SharedTestVariables.CLASS_ATTRIBUTE))
                .thenReturn(SharedTestVariables.CLASS_NAME);
    ...
    @Test
    public void testInputWebElement_byClass_doesNotHaveClass() {
        setBaseWhen(elementByClass);
        var notExpectingText = "NOT HERE <.< >.>";
        when(mockRawWebElement.getAttribute(SharedTestVariables.CLASS_ATTRIBUTE))
                .thenReturn(SharedTestVariables.CLASS_NAME);
    ...
    @Test
    public void testInputWebElement_byClass_getAttribute() {
        setBaseWhen(elementByClass);
        when(mockRawWebElement.getAttribute(SharedTestVariables.CLASS_ATTRIBUTE))
                .thenReturn(SharedTestVariables.CLASS_NAME);
        assertEquals(SharedTestVariables.CLASS_NAME,
    ...
    @Test
    public void testInputWebElement_byClass_getText() {
        setBaseWhen(elementByClass);
        when(mockRawWebElement.getText()).thenReturn(SharedTestVariables.TEXT_1);
    ...
    @Test
    public void testInputWebElement_byClass_getTagName() {
        setBaseWhen(elementByClass);
        when(mockRawWebElement.getTagName()).thenReturn(SharedTestVariables.TAG_NAME_1);
    ...
    @Test
    public void testInputWebElement_byClass_getLocation() {
        setBaseWhen(elementByClass);
        var testPoint = new Point(1, 1);
        when(mockRawWebElement.getLocation()).thenReturn(testPoint);
    ...
    @Test
    public void testInputWebElement_byClass_getSize() {
        setBaseWhen(elementByClass);
        var testDimension = new Dimension(1,1);
        when(mockRawWebElement.getSize()).thenReturn(testDimension);
    ...
    @Test
    public void testInputWebElement_byClass_getRect() {
        setBaseWhen(elementByClass);
        var testRectangle = new Rectangle(1, 1, 1, 1);
        when(mockRawWebElement.getRect()).thenReturn(testRectangle);
    ...
    @Test
    public void testInputWebElement_byClass_getCssValue() {
        setBaseWhen(elementByClass);
        var testCssProperty = "testProperty";
        var expectedTestCssValue = "Dagobah";
        when(mockRawWebElement.getCssValue(testCssProperty)).thenReturn(expectedTestCssValue);
    ...
    @Test
    public void testInputWebElement_byClass_getRawWebElement_success() {
        setBaseWhen(elementByClass);
        assertEquals(mockRawWebElement, elementByClass.getRawWebElement());
    }

    @Test
    public void testInputWebElement_byClass_getRawWebElement_fail() {
        setBaseWhen(elementByClass);
    ...
    @Test
    public void testInputWebElement_byClass_getRawParentWebElement_success() {
        setBaseWhen(elementByClass);
        setWhenGetRawParentElementSucceed();
    ...
    @Test
    public void testInputWebElement_byClass_getRawParentWebElement_fail() {
        setBaseWhen(elementByClass);
        setWhenGetRawParentElementFail();
    ...
    @Test
    public void testInputWebElement_byClass_scrollIntoView_success() {
        setBaseWhen(elementByClass);
        setWhenScrollIntoViewSucceed();
    ...
    @Test
    public void testInputWebElement_byClass_scrollIntoView_fail() {
        setBaseWhen(elementByClass);
        setWhenScrollIntoViewFail();
